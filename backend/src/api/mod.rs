...
pub fn create_router(state: Arc<AppState>) -> Router {
    ...
    Router::new()
        ...
        .route("/api/live/configuration-status", get(handlers::get_configuration_status))
        ...
        // ==========================================
        .route("/api/config/restrictions", get(handlers::get_restrictions))
        .route("/api/config/restrictions", put(handlers::update_restrictions))
        .route("/api/config/restrictions/refresh", post(handlers::refresh_restrictions))
        .route("/api/config/restrictions/reload", post(handlers::reload_restrictions))
