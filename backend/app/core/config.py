...
class Settings(BaseSettings):
    ...
    # ===========================================
    # Kraken API - Shadow Mode (read-only, paper trading)
    # Loaded from .env.kraken
    # ===========================================
    kraken_api_key: Optional[str] = None
    kraken_api_secret: Optional[str] = None
    kraken_private_key: Optional[str] = None
    kraken_shadow_mode: bool = True       # Default to shadow mode (safe)
    kraken_max_loss_usd: float = 30.0     # Hard limit for live trading
    
    # ===========================================
    # Kraken API - Live Trading (with order permissions)
    ...
    # Capital Management
    total_capital: float = 100.0          # Starting paper trading capital (USD)
...
def get_settings() -> Settings:
    ...
    env_files = [
        ".env.kraken",           # Kraken API keys (shadow mode)
        "/app/.env.kraken",      # Docker path for Kraken keys (shadow mode)
